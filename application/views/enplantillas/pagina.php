...
<head>
  ...
  <title>Lic. Alexander Damaso - Developer</title>
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
    <div class="container">
    <img class=" img-thumbnail d-none d-sm-block " src="./static/img/profile.jpg" height="50px" width="50px" alt="">

      <a class="navbar-brand js-scroll-trigger" href="#page-top">Lic. Alexander Damaso</a>
  ...
  <header class="masthead bg-info text-white text-center ">
    <div class="container d-flex align-items-center flex-column ">
      ...
      <img class="masthead-avatar mb-5 img-thumbnail " src="./static/img/profile.jpg" alt="">

      <!-- Masthead Heading -->
      <h1 class="masthead-heading text-uppercase mb-0">Lic. Alexander Damaso</h1>
      ...
      <!-- Masthead Subheading -->
      <p class="masthead-subheading font-weight-light mb-0">Web - Mobile - Desktop Developer</p>
  ...
  <section class="page-section portfolio" id="portfolio">
    <div class="container">
      ...
      <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Expertise</h2>
      ...
      <div class="row pt-4">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#experienciaModal1">
              <h4 href="#" class='text-dark'><i class="fas fa-star"></i> Election page </h4>
        ...
        <!-- Portfolio Item 2 -->
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#experienciaModal2">
              <h4 href="#" class='text-dark'><i class="fas fa-star"></i> Point of sale </h4>
            <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
        ...
        <!-- Portfolio Item 3 -->
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#experienciaModal3">
              <h4 href="#" class='text-dark'><i class="fas fa-star"></i> Book catalog API</h4>
            <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
              <div class="portfolio-item-caption-content text-center text-white">
              </div>
            </div>
        ...
        <!-- Portfolio Item 4 -->
        <div class="col-md-6 col-lg-4 pb-3"  style="visibility: hidden">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#experienciaModal4">
            <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
              <div class="portfolio-item-caption-content text-center text-white">
        ...
        <div class="col-md-6 col-lg-4" style="display: none">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#experienciaModal5">
            <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
              <div class="portfolio-item-caption-content text-center text-white">
                <i class="fas fa-plus fa-3x"></i>
              </div>
        ...
        <!-- Portfolio Item 6 -->
        <div class="col-md-6 col-lg-4"  style="display: none">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#experienciaModal6">
            <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
              <div class="portfolio-item-caption-content text-center text-white">
                <i class="fas fa-plus fa-3x"></i>
              </div>
  ...
  <section class="page-section bg-primary text-white mb-0" id="about">
    <div class="container">
      ...
      <h2 class="page-section-heading text-center text-uppercase text-white">Who am I?</h2>
      ...
      <div class="row">
        <div class="col-lg-4 ml-auto">
          <p class="lead">I am a very friendly person, passionate about developing applications on mobile, websites and desktops platforms. I'm one of those who believe in always-learning so I am always open to learn new technologies.</p>
        </div>
        <div class="col-lg-4 mr-auto">
          <p class="lead">I studied computer science at Federico Henriquez y Carvajal University and software development technologies at the Technological Institute of the Americas. </p>
        </div>
      </div>

      <!-- About Section Button -->
      <div class="text-center mt-4" style="visibility:none">
        <a class="btn btn-xl btn-outline-light" href="https://www.linkedin.com/in/alexander9306/">
          ...
          <form name="sentMessage" id="contactForm" novalidate="novalidate">
            ...
            <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-0 pb-2">
                ...
                <input class="form-control" id="phone" type="tel" placeholder="WhatsApp" required="required" data-validation-required-message="Please enter your phone number.">
                <p class="help-block text-danger"></p>
              </div>
            </div>
            <div class="control-group">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 mb-5 mb-lg-0" >
          ...
          <p class="lead mb-0">Dominican Republic
            </p>
        </div>
        ...
        <div class="col-lg-6 mb-5 mb-lg-0">
          ...
          <a class="btn btn-outline-light btn-social mx-1"  href="https://www.linkedin.com/in/alexander9306/">
            <i class="fab fa-fw fa-linkedin-in"></i>
          </a>
          <a class="btn btn-outline-light btn-social mx-1" href="https://github.com/alexander9306">
          <i class="fab fa-github"></i>
          </a>
          <a class="btn btn-outline-light btn-social mx-1" href="https://wa.me/18099146924/?text=Hola%20te%20contacto%20a%20travez%20de%20tu%20pagina%20web.">
        ...
        <div class="col-lg-4" style="display:none">
          <h4 class="text-uppercase mb-4">For contact</h4>
          <p class="lead mb-0"><i class="far fa-envelope mr-2"></i>alexander9306@gmail.com </p>
        </div>
  ...
  <section class="copyright py-4 text-center text-white">
    <div class="container">
      <small>Copyright &copy; Alexander Damaso 2019</small>
    </div>
  </section>
  ...
  <!-- Portfolio Modal 1 -->
  <div class="portfolio-modal modal fade" id="experienciaModal1" tabindex="-1" role="dialog" aria-labelledby="experienciaModal1Label" aria-hidden="true">
          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-lg-8">
                ...
                <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0">Election Page</h2>
                <!-- Icon Divider -->
                <div class="divider-custom">
                  <div class="divider-custom-line"></div>
                  <div class="divider-custom-icon">
                ...
                <a id="pt1" class="zoom">
                  <img class="img-fluid rounded mb-5" id="portafolio-img1" src="./static/img/pagina_electoral.png" alt="">
                </a>
                <!-- Portfolio Modal - Text -->
                <p class="mb-1">This project consists of a complete voting system which has a voting model, a polling station and a configuration module. </p>
                <div class="mb-3 pt-2">Programming languages & tools used:</div>
  ...
  <!-- Portfolio Modal 2 -->
  <div class="portfolio-modal modal fade" id="experienciaModal2" tabindex="-1" role="dialog" aria-labelledby="experienciaModal2Label" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">
        ...
        <div class="modal-body text-center">
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-lg-8">
                <!-- Portfolio Modal - Title -->
                <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0">Point of Sale</h2>
                <!-- Icon Divider -->
                <div class="divider-custom">
                  <div class="divider-custom-line"></div>
                  <div class="divider-custom-icon">
                ...
                <!-- Portfolio Modal - Image -->
                <a id="pt2" class="zoom">
                <img class="img-fluid rounded mb-5" src="./static/img/sistema_inventario.png" alt="">
                </a>
                <!-- Portfolio Modal - Text -->
                <p class="mb-1">This is a web application to handle the entry and exit of products from a store or shopping center as well as the incomes generated by those sales.</p>
                <div class="mb-3 pt-2">Programming languages & tools used:</div>    
                <div class='h1 text-primary'>
                  <ul class="list-inline  pb-5">
                    <li class="list-inline-item">
  ...
  <!-- Portfolio Modal 3 -->
  <div class="portfolio-modal modal fade" id="experienciaModal3" tabindex="-1" role="dialog" aria-labelledby="experienciaModal3Label" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">
        ...
        <div class="modal-body text-center">
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-lg-8">
                <!-- Portfolio Modal - Title -->
                <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0">Book catalog API</h2>
                <!-- Icon Divider -->
                <div class="divider-custom">
                  <div class="divider-custom-line"></div>
                  <div class="divider-custom-icon">
                ...
                <!-- Portfolio Modal - Text -->
                <p class="mb-5">This is a REST API that returns JSON data when a request for any book on the database.</p>
                <div class="mb-3 pt-2">Programming languages & tools used:</div>    
                <div class='h1 text-primary'>
                  <ul class="list-inline  pb-5">
                    <li class="list-inline-item">
  ...
  <!-- Portfolio Modal 4 -->
  <div class="portfolio-modal modal fade" id="experienciaModal4" tabindex="-1" role="dialog" aria-labelledby="experienciaModal4Label" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">
  ...
  <!-- Portfolio Modal 5 -->
  <div class="portfolio-modal modal fade" id="experienciaModal5" tabindex="-1" role="dialog" aria-labelledby="experienciaModal5Label" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">
  ...
  <!-- Portfolio Modal 6 -->
  <div class="portfolio-modal modal fade" id="experienciaModal6" tabindex="-1" role="dialog" aria-labelledby="experienciaModal6Label" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">
