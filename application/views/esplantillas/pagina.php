...
<head>
  ...
  <title>Desarrollador - Lic. Alexander Damaso</title>
...
<body id="page-top">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#portfolio">Experiencia</a>
          </li>
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#about">¿Quién Soy?</a>
          </li>
          <li class="nav-item mx-0 mx-lg-1">
  ...
  <header class="masthead bg-info text-white text-center">
    <div class="container d-flex align-items-center flex-column">
      ...
      <img class="masthead-avatar mb-5 img-thumbnail " id="img_profile" src="./static/img/profile.jpg" alt="">
      ...
      <!-- Masthead Subheading -->
      <p class="masthead-subheading font-weight-light mb-0">Desarrollador Web - Movil - Desktop</p>
    ...
    <div class="container">
      ...
      <div class="row pt-4">
        ...
        <div class="col-md-6 col-lg-4">
          ...
          <h4 href="#" class='text-dark'><i class="fas fa-star"></i> Pagina electoral </h4>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#experienciaModal2">
              <h4 href="#" class='text-dark'><i class="fas fa-star"></i> Punto de venta </h4>
            <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#experienciaModal3">
              <h4 href="#" class='text-dark'><i class="fas fa-star"></i> Catalogo de libros API</h4>
            <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
              <div class="portfolio-item-caption-content text-center text-white">
              </div>
            </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 ml-auto">
          <p class="lead">Soy una persona muy amigable, apasionada con el desarrollo de aplicaciones en plataformas moviles, webs y desktops. Soy de los que creen en el always-learning por eso siempre estoy abierto a aprender las nuevas tecnologías.</p>
        </div>
        <div class="col-lg-4 mr-auto">
          <p class="lead">Soy graduado de la carrera ciencias computacionales en la universidad Federico Henriquez y Carvajal y el tecnologo en desarrollo de software en el Instituto Tecnológico de las Américas. </p>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 mb-5 mb-lg-0" >
          ...
          <p class="lead mb-0">Republica Dominicana
            </p>
        </div>

        <!-- Footer Social Icons -->
        <div class="col-lg-6 mb-5 mb-lg-0">
          <h4 class="text-uppercase mb-4">Mas Información</h4>
        ...
        <div class="col-lg-4" style="display:none">
          <h4 class="text-uppercase mb-4">Para contactos</h4>
          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-lg-8">
                ...
                <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0">Pagina Electoral</h2>
                <!-- Icon Divider -->
                <div class="divider-custom">
                  <div class="divider-custom-line"></div>
                  <div class="divider-custom-icon">
                ...
                <p class="mb-1">Este proyecto consiste en una pagina de votacion completa la cual posee un modelo para las votaciones, una mesa electoral y un modulo de configuracion.</p>
                <div class="mb-3 pt-2">Lenguajes de programacion & herramientas utilizados:</div>
        ...
        <div class="modal-body text-center">
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-lg-8">
                <!-- Portfolio Modal - Title -->
                <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0">Punto de Venta</h2>
                <!-- Icon Divider -->
                <div class="divider-custom">
                  <div class="divider-custom-line"></div>
                  <div class="divider-custom-icon">
                ...
                <!-- Portfolio Modal - Text -->
                <p class="mb-1">Es una aplicacion web para el ingreso, y salida de productos de una tienda o centro comercial.</p>
                <div class="mb-3 pt-2">Lenguajes de programacion & herramientas utilizados:</div>    
                <div class='h1 text-primary'>
                  <ul class="list-inline  pb-5">
                    <li class="list-inline-item">
        ...
        <div class="modal-body text-center">
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-lg-8">
                <!-- Portfolio Modal - Title -->
                <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0">Catalogo de libros API</h2>
                <!-- Icon Divider -->
                <div class="divider-custom">
                  <div class="divider-custom-line"></div>
                  <div class="divider-custom-icon">
                ...
                <!-- Portfolio Modal - Text -->
                <p class="mb-5">Esta es una API REST que devuelve datos de tipo JSON sobre peticiones de libros</p>
                <div class="mb-3 pt-2">Lenguajes de programacion & herramientas utilizados:</div>    
                <div class='h1 text-primary'>
                  <ul class="list-inline  pb-5">
                    <li class="list-inline-item">
